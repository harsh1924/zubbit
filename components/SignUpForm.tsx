...
const SignUpForm = () => {
    ...
    const onSubmit = async (data: z.infer<typeof SignUpSchema>) => {
        ...
        try {
            ...
            setVerifying(true); // Setting it true will render OTP Verification UI
        } catch (error: any) {
    ...
    const handleVerificationSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            setVerificationError(error.errors?.[0]?.message || "An error occured during otp verification. Please try again.");
        } finally {
            setIsSubmitting(false);
        }
    }
